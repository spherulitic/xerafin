...
#		con.execute("alter table user_prefs add showHints varchar(1)");
		con.execute("update user_prefs set showHints = 'N'");
		con.execute("select count(*) from user_prefs")
		print "Table updated successfully. {0} rows returned.".format(con.fetchone()[0])
